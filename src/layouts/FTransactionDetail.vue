        ...
        <f-card>
            <template v-if="!dTransactionByHashError">
                ...
                <div class="row no-collapse">
                    ...
                    <div class="col"><div class="break-word" v-show="cTransaction">{{  WEIToGLXY(cTransaction.value) }} GLXY</div></div>
                </div>
                <!--
                            <div class="row no-collapse">
                                <div class="col-4 f-row-label">{{ $t('view_transaction_detail.fee') }}</div>
                                <div class="col"><div class="break-word" v-show="cTransaction">{{  WEIToGLXY(cTransaction.fee) }} GLXY</div></div>
                            </div>
                -->
                <div class="row no-collapse">
                ...
                <div class="row no-collapse">
                    ...
                    <div class="col"><div class="break-word" v-show="cTransaction">{{  cTransactionFee }} GLXY</div></div>
                </div>
                <div class="row no-collapse">
    ...
    export default {
        ...
        computed: {
            ...
            cTransactionFee() {
                ...
                if (transaction) {
                    return WEIToGLXY(this.formatHexToInt(transaction.gasPrice) * this.formatHexToInt(transaction.gasUsed));
                }
