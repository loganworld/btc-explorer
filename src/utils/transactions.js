...
const WEI_IN_GLXY = 1e18;

/**
 * @return {number}
 */
export function WEIToGLXY(_value) {
    return (_value / WEI_IN_GLXY);
}

/**
 * @return {number}
 */
export function GLXYToWEI(_value) {
    return _value * WEI_IN_GLXY;
}
 ...
 * @return {number}
 */
export function GLXYToUSD(_value, _tokenPrice = 0.002) {
