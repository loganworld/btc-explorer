 ...
 * @property {number} rewardCollateralRatio4 Minimal ratio between collateral and debt values in ref. denomination (USD) on which the account is eligible for rewards distribution.
 ...
 * @property {number} price Value of the token in ref. denomination (USD).
 ...
 * @property {boolean} canWrap Signals if the token can be used to wrap native coin tokens for DeFi trading.
 ...
 * @property {string} value Value of the current balance of the token on the account in ref. denomination (USD).
 */
 ...
 * @property {string} collateralValue Current collateral value in ref. denomination (USD).
 ...
 * @property {string} debtValue Current debt value in ref. denomination (USD).
