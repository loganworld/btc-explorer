<template>
    <span class="f-token-value" :title="cValue">
        ...
        >
            ...
            <router-link :to="to" v-if="!noCurrency" class="currency">{{
                tokenSymbol
            }}</router-link>
        </f-placeholder>
        <template v-else>
    ...
    computed: {
        ...
        cValue() {
            ...
            if (this.convertValue) {
                value = this.value/1000000000000000000; //this.$defi.fromTokenValue(this.value, this.token);
            }
